...
import { Check, ChevronDown, ChevronRight, LogOut, Shield } from 'lucide-react-native';
...
function SegmentedControl({ options, selectedValue, onSelect, isDark }: SegmentedControlProps) {
  const colors = Colors[isDark ? 'dark' : 'light'];

  return (
    <View style={[styles.segmentedControl, { backgroundColor: isDark ? '#1A1A1A' : '#E5E5E5' }]}>
      {options.map((option) => {
        const isSelected = option.value === selectedValue;
        return (
          <Pressable
            key={option.value}
            style={[styles.segmentedOption, isSelected && { backgroundColor: colors.tint }]}
  ...
  return (
    <>
      ...
      <View style={[styles.dropdownContainer, { zIndex: isOpen ? 1000 : zIndex }]}>
        <TouchableOpacity
          style={[styles.dropdownButton, { backgroundColor: isDark ? '#1A1A1A' : '#E5E5E5' }]}
              ...
              return (
                ...
                >
                  <View style={styles.dropdownOptionContent}>
                    ...
                    {option.description && (
                      <Text
                        style={[styles.dropdownOptionDescription, { color: colors.textSecondary }]}
                      >
                        {option.description}
                      </Text>
                    )}
  ...
  return (
    <>
      ...
      >
        {isAdmin && (
          <>
            <Text style={[styles.sectionHeader, { color: colors.textSecondary }]}>ADMIN</Text>
            <Card isDark={isDark}>
              <TouchableOpacity style={styles.adminRow} onPress={() => router.push('/admin')}>
                <Shield color={COLORS.accent} size={20} />
                <Text style={[styles.adminRowText, { color: colors.text }]}>Admin Portal</Text>
        ...
        <Text style={[styles.sectionHeader, { color: colors.textSecondary }]}>UNITS</Text>
        <Card isDark={isDark}>
        ...
        <Text style={[styles.sectionHeader, { color: colors.textSecondary }]}>GPS</Text>
        <Card isDark={isDark}>
          <SettingRow
        ...
        <Text style={[styles.sectionHeader, { color: colors.textSecondary }]}>LAUNCH DETECTION</Text>
        <Card isDark={isDark}>
          <SettingRow
            label="Threshold"
        ...
        <Card isDark={isDark}>
          <SettingRow
            ...
            isDark={isDark}
          >
            <Toggle value={hapticFeedback} onValueChange={setHapticFeedback} isDark={isDark} />
          </SettingRow>
          ...
          <SettingRow
            ...
            isDark={isDark}
          >
            <Toggle value={autoSaveRuns} onValueChange={setAutoSaveRuns} isDark={isDark} />
          </SettingRow>
        </Card>
        ...
        <Text style={[styles.versionText, { color: colors.textSecondary }]}>
          FastTrack v{Constants.expoConfig?.version ?? '1.3.0'}
        </Text>
      </ScrollView>
    </>
  );
